...
{
		var configToRegister = {senderid:"726651452349"};
...
//kony.net.invokeServiceAsync/kony.net.invokeService are depricated, replacing with new APIs wrapper
    _invokeServiceAsyncForMF_(url,{},fetchMsgSucessCallback);
...
function fetchMessagesonClick(eventobject) {
    ...
    var url = kpnsURL+"/service/entrydata/fetchmessages";
   	kony.print("url:"+url);
//kony.net.invokeServiceAsync/kony.net.invokeService are depricated, replacing with new APIs wrapper
    _invokeServiceAsyncForMF_(url,{"userId":mailId, "startElement":"1", "elementsPerPage":"10"},fetchMessagesSucessCalllback);
    kony.application.showLoadingScreen("loadingscreen", "Loading...", constants.LOADING_SCREEN_POSITION_FULL_SCREEN, true, true, null);
};
...
//kony.net.invokeServiceAsync/kony.net.invokeService are depricated, replacing with new APIs wrapper
    _invokeServiceAsyncForMF_(url,{},satusCallback);
