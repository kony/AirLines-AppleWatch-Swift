...
{  if( (typeof bol === "undefined") || (bol==true)){
	  ...
	  var allFlightsData = {"flightdetails":allFlights,"version":versionCounter};
...
function onRowClick()
{
	...
	if((currentSeg["lblGate"]) == ("- -"))
	    frmFlightDetail.btnCheckin.setVisibility(true);
	else
	frmFlightDetail.btnCheckin.setVisibility(false); 
...
function onHomeRowClick()
{
	...
	if((currentSeg["lblHome"]) == ("Book a trip"))
	    frmBookFlight.show();
