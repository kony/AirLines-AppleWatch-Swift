 ...
 *************************************************************************************/
function frmFlightDetailsPreshow() {
    frmBookFlight.cbxFlightSource.masterData = [
        ["Acapulco", "ACA"],
        ["Lanzarote", "ACE"],
        ["Atlantic City", "AIY"],
        ["Alice Springs", "ASP"],
    ...
    frmBookFlight.cbxFlightDestination.masterData = [
        ["Acapulco", "ACA"],
        ["Lanzarote", "ACE"],
        ["Atlantic City", "AIY"],
        ["Alice Springs", "ASP"],
...
function checkin() {
    ...
    if (CheckInFrom == "frmAdd") currentSeg = frmAdd.segFDetails.selectedItems[0];
    else currentSeg = frmFlights.segFDetails.selectedItems[0];
