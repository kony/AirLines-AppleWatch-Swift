...
function handleGlanceDataRequest(dict) {
    ...
    if (allFlightsData != null) {
        ...
        flightData["flightTimeStatus"] = {
            "visible": true
        };
        flightData["seatGroup"] = {
            "visible": true
        };
        flightData["openAppLabel"] = {
            "visible": false
        };
        flightData["noFlightLabel"] = {
            "visible": false
        };
    ...
    if (dataDict != null) {
        ...
        if (flightsData != null && (flightsData.length > 0)) {
            ...
            var tableViewRowData = {
                "controller": "AllFlightsCustomRowTemplate",
                "rows": flightsData
            };
            retFlightsDataDict["tableView"] = {
                "data": tableViewRowData,
                "visible": true
            };
            retFlightsDataDict["noFlightsLabel"] = {
                "visible": false
            };
            retFlightsDataDict["bookNowLabel"] = {
                "visible": false
            };
            retFlightsDataDict["noFlightsLogo"] = {
                "visible": false
            };
        } else {
